...
const Item = styled.li`
    margin-right: 20px;
    color:${(props)=>props.theme.while.darker};
...
const Input = styled(motion.input)`
    ...
    border: 1px solid ${(props) => props.theme.while.lighter};
`
...
function Header(){
    ...
    return (
        ...
        initial={"top"} animate={navAnimation}>
            <Col>
                <Logo 
                ...
                <Items>
                    <Link to="/">
                        <Item>Home 
                            {homeMatch && <Circle layoutId="circle"></Circle>}
                        </Item>
                    </Link>
                    <Link to="tv">
                        <Item>
                            Tv Shows 
                            {tvMatch && <Circle layoutId="circle"></Circle>}
                        </Item>
                    </Link>
                </Items>
            </Col>
            <Col>
               <Search onSubmit={handleSubmit(onValid)}>
                    ...
                    initial={{scaleX:0}}
                    transition={{type:"linear"}}
                    placeholder="Search fro moive or tv show"/>
               </Search>
            </Col>
        </Nav>
    );
